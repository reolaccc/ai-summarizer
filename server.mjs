  ...
  if (summaryMode === "key_insights") {
    ...
    payload = {
      ...
      summaryBullets: [
        ...
        { text: "Why it matters: the whole flight is a system test, so a smooth sequence shows the vehicle is getting closer to routine reliability.", level: 1 },
        { text: "Supporting details: the launch window opens Thursday, May 21 at 5:30 p.m. CT and the webcast begins about 45 minutes earlier.", level: 1 },
        { text: "Implications: if the sequence works, SpaceX gains confidence in the vehicle's core launch, separation, and landing behavior.", level: 1 },
        ...
        { text: "Why it matters: avoiding a catch keeps the focus on proving the redesigned booster can fly through the key stages first.", level: 1 },
        { text: "Supporting details: the booster is meant to complete launch, ascent, stage separation, boostback burn, and landing burn.", level: 1 },
        { text: "Implications: a successful run would show the booster can handle its flight duties before SpaceX asks it to do even more.", level: 1 },
        { text: "The upper stage is also carrying payload and reentry tests that help prepare future missions.", level: 0 },
        { text: "Why it matters: these tests connect today's flight to the longer-term goal of reuse and future return-to-site missions.", level: 1 },
        { text: "Supporting details: the upper stage plans to deploy 20 Starlink simulators, two specially modified satellites, and attempt a Raptor relight.", level: 1 },
        { text: "Implications: if those tests go well, SpaceX gets more data on heat shield imaging, relight behavior, and reentry stress.", level: 1 },
      ],
      insightPairs: [],
      questions: [
    ...
    payload = {
      ...
      summaryBullets: [
        ...
        { text: "Why it matters: readers need the main conclusion before any supporting detail.", level: 1 },
        { text: "Supporting details: the summary should point to the specific facts that prove the conclusion.", level: 1 },
        { text: "Implications: a clear first takeaway helps the rest of the structure feel organized instead of random.", level: 1 },
        { text: "Core takeaway 2: the next layer should explain the evidence or example behind the idea.", level: 0 },
        { text: "Why it matters: this is what turns a generic summary into something useful and memorable.", level: 1 },
        { text: "Supporting details: examples, consequences, and reasons should sit under the main point, not float alone.", level: 1 },
        { text: "Implications: the reader can scan the shape of the argument and understand the logic quickly.", level: 1 },
        { text: "Core takeaway 3: the final layer should show why the information matters going forward.", level: 0 },
        { text: "Why it matters: without the effect or implication, the summary feels unfinished.", level: 1 },
        { text: "Supporting details: the source should be translated into what this means in practice.", level: 1 },
        { text: "Implications: the summary becomes a small decision map instead of a flat list of facts.", level: 1 },
      ],
      insightPairs: [],
      questions: [
